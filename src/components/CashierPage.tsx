...
const CashierPage: React.FC<CashierPageProps> = ({ onBack, onNavigateToMemberManagement, onNavigateToSettings }) => {
  ...
  // Note: Keyboard shortcuts like F4 are not natively supported in mobile apps
  // They would require special hardware or platform-specific implementations
  // For now, we rely on UI navigation instead
